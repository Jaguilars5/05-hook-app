# 🎣 React Hooks - Prácticas y Ejemplos
...
- **React Testing Library** 14.2.1 - Testing de componentes
- **Babel** 7.23.9 - Compilador de JavaScript
...
Para ver el árbol de directorios completo, consulta [Estructura del Proyecto](./ESTRUCTURA.md).
